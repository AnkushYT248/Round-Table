...
const CarouselLinks = ({ data, isLoading }) => {
      ...
      <div className="w-full max-w-[200vw] mx-auto relative scroll bg-white dark:bg-[#0f0f10]">
        ...
        >
          {data
            ...
            <Link href={"/courses/"} className="mx-4 px-4 py-2 rounded-md transition-colors whitespace-nowrap hover:text-blue-500 duration-300 text-black/80 dark:text-white text-sm">All Courses</Link>
            <Link href={"/tutorials/"} className="mx-4 px-4 py-2 rounded-md transition-colors whitespace-nowrap hover:text-blue-500 duration-300 text-black/80 dark:text-white text-sm">All Tutorials</Link>
        </div>
        <button
